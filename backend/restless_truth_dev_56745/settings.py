"""
Django settings for restless_truth_dev_56745 project.
...
ROOT_URLCONF = 'restless_truth_dev_56745.urls'
...
WSGI_APPLICATION = 'restless_truth_dev_56745.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_truth_dev_56745 API",
    "DESCRIPTION": "API documentation for restless_truth_dev_56745 App",
    "VERSION": "v1",
}
