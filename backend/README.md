...
## Project Structure
    ...
    ├── restless_truth_dev_56745  # Django project configurations
...
1. Clone this repo and `cd restless_truth_dev_56745`
...
2. Clone this repo and `cd restless_truth_dev_56745`
